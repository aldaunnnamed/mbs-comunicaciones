...
DROP FUNCTION IF EXISTS fn_admin_listar_clientes(VARCHAR,VARCHAR,INT) CASCADE;
...
DROP FUNCTION IF EXISTS fn_producto_datos(VARCHAR,INT) CASCADE;
DROP FUNCTION IF EXISTS fn_admin_listar_productos(VARCHAR,INT,VARCHAR,INT,INT) CASCADE;
DROP FUNCTION IF EXISTS fn_guardar_producto(INT,VARCHAR,VARCHAR,VARCHAR,TEXT,INT,INT,NUMERIC,NUMERIC,INT,INT,VARCHAR,VARCHAR,INT) CASCADE;
...
DROP FUNCTION IF EXISTS fn_carrito_aplicar_cupon(INT,INT,VARCHAR) CASCADE;
