...
-- Fusiona el carrito anónimo (session_key) al carrito del usuario al hacer login
...
-- Guarda notas internas de un pedido sin disparar la notificación de
-- "cambio de estado" al cliente que sí envía fn_actualizar_estado_pedido.
